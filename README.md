...
the default is `https://zkfmi.github.io/aemeth`.

Requested domain: `aemeth.fi` (Marcaria). Domain registration, DNS,
...
Aemeth uses its own brand and bilingual copy. Technical implementation sources
