...
</main><footer class="shell footer"><div><a class="wordmark" aria-label="Aemeth home" href="{prefix}">æmeth<span class="wordmark-period">.</span></a><p>{d['footer']}</p></div><p class="brand-note">{d['brand_note']}</p><div class="footer-end"><span>© 2026 Aemeth</span><a href="{tech}">zkfmi.com</a><a href="https://github.com/zkFMI/aemeth">GitHub</a></div></footer></body></html>'''
